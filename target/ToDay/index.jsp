...
<c:if test="${empty user}">
  <div style=" background: url(${ctx}/static/images/banner_top.jpg) top center; height: 265px; overflow: hidden ">
    <section class="box">
        <ul class="texts">
          <p>${user.autograph1}</p>
          <p>${user.autograph2}</p>
          <p>${user.autograph3}<a href="" onclick="function n(){} return false"></a></p>
        </ul>
      <div class="avatar">
        <a href="#" STYLE="background: url(${ctx}/static/images/nh.png) no-repeat; background-size: 130px 130px">
          <span>请先登陆</span>
        </a>
      </div>
    </section>
...
<script src="${ctx}/static/js/indexShow.js"></script>
