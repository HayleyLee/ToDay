...
<header>
    ...
    <nav class="topnav" id="topnav">
        ...
        <a href="#"><span>我的关注</span><span class="en">i like this guy</span></a>
...
<script>
    function AppendFollow(userimg,username,autograph1,autograph2,autograph3,HowManyFollow,TheGuyFollow,TheGuyUpload,FollowTime){
        ...
        $.ajax({
            ...
            success:function (json){
                for(var i=0;i<json.length;i++){
                    ...
                    AppendFollow(userimg,username,autograph1,autograph2,autograph3,HowManyFollow,TheGuyFollow,TheGuyUpload,FollowTime);
                }
            },
            error:function () {
